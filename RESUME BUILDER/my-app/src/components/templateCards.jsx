...
import temp10 from '../images/temp10.jpg';
...
const WithoutAiTemp = ({ setActiveStep }) => {
  ...
  const templates = [
    ...
    },
    {
      ...
      name: "Better Design",
      preview: temp8,
      description: "Professionally designed layout with vibrant colors",
      url: "/Temp8",
    },
    {
      id: 9,
    ...
    },
    {
      ...
      preview: temp10,
      description: "Professionally design your Resume",
      url: "/Temp10",
    }
  ];
