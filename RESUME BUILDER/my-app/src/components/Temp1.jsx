...
const Temp1 = () => {
    ...
    const downloadPdf = async () => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/api/resume/save`, { resumeData: resume });
    ...
    const saveAndEnhanceResume = async () => {
        ...
        try {
            ...
            const saveResponse = await axios.post(`${BASE_URL}/api/resume/save`, {
                resumeData: resume,
            });
            ...
            if (saveResponse.data?.data?._id) {
                ...
                const enhanceResponse = await axios.post(`${BASE_URL}/api/resume/enhanceField`, {
    ...
    const createResume = async () => {
        try {
            const response = await axios.post(`${BASE_URL}/api/resume/create`, {
                resumeData: {
                    name: resume.name,
                    role: resume.role,
                    phone: resume.phone,
